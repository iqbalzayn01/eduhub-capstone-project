                ...
                <article className='bg-black rounded-2xl p-4 lg:p-12 text-white overflow-hidden'>
                  ...
                  <div>
                    ...
                    <p className='mt-4 text-sm lg:text-xl'>
                      ...
                      <a
                        href='#'
                        className='text-[#CDFE05] underline'>
                        Sarah Reynolds
                      </a>{' '}
                      - 05 March , 2024
                    </p>
                    <p className='mt-6 text-sm lg:text-xl'>
                      Dive into the rich tapestry of creativity with our blog, &quot;Unlocking
                      Creativity Chronicles.&quot; Explore insightful articles, behind-the-scenes
                      stories, and captivating tales from the symposium.
                    </p>
                  </div>
                  <a href='#'>
                  ...
                  <article
                    ...
                    <div className='flex flex-col justify-between h-full'>
                      <div>
                        ...
                        <h2 className='mt-4 text-xl font-medium'>Saturday, 12 March 2024</h2>
                      </div>
                  ...
                  <article
                    ...
                    <div className='flex flex-col justify-between h-full'>
                      <div>
                        ...
                        <h2 className='mt-4 text-xl font-medium'>Sunday, 12 May 2024</h2>
                      </div>
                      <div className='flex justify-between'>
                        <div className='flex gap-4 items-end text-2xl font-semibold'>
                          Event <FiArrowUpRight className='text-3xl' />
            ...
            <div className='mt-12 lg:mt-28 lg:px-8 flex justify-between flex-col lg:flex-row relative'>
              ...
              <div className='mt-8 lg:mt-0 relative z-10'>
                <p className='font-medium leading-relaxed text-xl'>
                  Welcome to EduHub, where insights meet connections. We&apos;re on a mission to
                  create a platform for thought-provoking events that transcend borders. EduHub is
                  your destination for quality content, global connections, and a seamless
                  insight-gathering experience. Join our thriving community, and let&apos;s shape
                  the future of knowledge together. At EduHub, every insight gathered is a step
